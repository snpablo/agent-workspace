...
This poster explains how agents combine instructions, tools, skills, and runtime state during execution.
...
- **Tools** expose capabilities through provider-backed interfaces.
